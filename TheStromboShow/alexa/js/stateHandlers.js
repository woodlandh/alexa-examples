...
var stateHandlers = {
    startModeIntentHandlers : Alexa.CreateStateHandler(constants.states.START_MODE, {
        ...
        'LaunchRequest' : function () {
            ...
            var message = 'You are listening to the Strombo Show. Say feed the good wolf to begin.';
            var reprompt = 'You can say, feed the good wolf, to begin.';
        ...
        'Unhandled' : function () {
            var message = 'Sorry, I could not understand. Please say, feed the good wolf, to begin the audio.';
            this.response.speak(message).listen(message);
            this.emit(':responseReady');
        }
    }),
    playModeIntentHandlers : Alexa.CreateStateHandler(constants.states.PLAY_MODE, {
        ...
        'LaunchRequest' : function () {
            ...
            if (this.attributes['playbackFinished']) {
                this.handler.state = constants.states.START_MODE;
                message = 'You are listening to the Strombo Show. Say feed the good wolf to begin.';
                reprompt = 'You can say, feed the good wolf, to begin.';
            } else {
        ...
        'AMAZON.HelpIntent' : function () {
            ...
            var message = 'You are listening to the Strombo Show. You can say, Next or Previous to navigate through the playlist. ' +
